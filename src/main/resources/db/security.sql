...
CREATE TABLE articles (
  id BIGINT(64) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  user_id BIGINT(64) NOT NULL COMMENT 'User id',
  ...
  created_at BIGINT(13) NOT NULL COMMENT 'Created at',
  updated_at BIGINT(13) NOT NULL COMMENT 'Updated at',
  CONSTRAINT pk_articles PRIMARY KEY (id),
  UNIQUE KEY slug (slug)
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT 'Articles table';
...
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT 'Follows table';
...
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT 'Tags table';
...
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT 'Article tags relationship table';
...
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT 'Comments table';