...
INSERT INTO permission VALUES (7, 'Monitor online user page', '/monitor', 1, 'page:monitor:online', NULL, 2, 0);
INSERT INTO permission VALUES (8, 'Monitor online user button-query', '/**/monitor/online/user', 2, 'btn:monitor:online:query', 'GET', 1, 7);
INSERT INTO permission VALUES (9, 'Monitor online user button-kick-out', '/**/monitor/online/user/kick-out', 2, 'btn:monitor:online:kick-out', 'DELETE', 2, 7);
INSERT INTO permission VALUES (10, 'Permission page', '/permissions', 1, 'page:permissions', NULL, 3, 0);
INSERT INTO permission VALUES (11, 'Permission button-list-permission', '/**/permissions', 2, 'btn:permissions:list', 'GET', 1, 10);
INSERT INTO permission VALUES (12, 'Permission button-permission', '/**/permissions/{id}', 2, 'btn:permissions:query', 'GET', 2, 10);
INSERT INTO permission VALUES (13, 'Permission button-add-permission', '/**/permissions', 2, 'btn:permissions:insert', 'POST', 3, 10);
INSERT INTO permission VALUES (14, 'Permission button-update-permission', '/**/permissions/{id}', 2, 'btn:permissions:update', 'PUT', 4, 10);
INSERT INTO permission VALUES (15, 'Permission button-delete-permission', '/**/permissions/{id}', 2, 'btn:permissions:delete', 'DELETE', 5, 10);
...
INSERT INTO role VALUES (1, 'Administrator', 'Super administrator', 1544611947239, 1544611947239);
INSERT INTO role VALUES (2, 'General user', 'General user', 1544611947246, 1544611947246);
...
INSERT INTO user VALUES (1, 'admin', '$2a$10$64iuSLkKNhpTN19jGHs7xePvFsub7ZCcCmBqEYw8fbACGTE3XetYq', 'Admin', '17300000000', 'admin@xkcoding.com', 785433600000, 1, 1, 1544611947032, 1544611947032);
INSERT INTO user VALUES (2, 'user', '$2a$10$OUDl4thpcHfs7WZ1kMUOb.ZO5eD4QANW5E.cexBLiKDIzDNt87QbO', 'User', '17300001111', 'user@xkcoding.com', 785433600000, 1, 1, 1544611947234, 1544611947234);
